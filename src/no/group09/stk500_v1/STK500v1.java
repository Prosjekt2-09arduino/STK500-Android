...
//				intInput = input.read();
	...
	private void uploadFile() {
		...
		int hexLength = hex.getLines();
		// Counter used to keep the position in the hex-file
		int hexPosition = 0;
		
		//Run throug the entire hex file
		while (hexPosition < hexLength) {
			...
			byte[] nextLine = hex.getHexLine(hexPosition);
			...
			//Programming of page was successfull. Increment counter and program
			//next page
